...
const contactSchema = {
    ...
    "mainEntity": {
        ...
        "address": {
            "@type": "PostalAddress",
            "streetAddress": "4 Highlands Road",
            ...
            <section className="py-24 bg-brand-cream border-b border-brand-slate/10 -mt-20">
                <div className="container mx-auto px-4 max-w-6xl">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-16 relative z-20 max-w-3xl mx-auto">
                        ...
                        <a href="mailto:hello@webdesignfortradespeople.co.uk" className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-t-brand-ai text-center group hover:-translate-y-2 transition-transform">
                            <div className="h-16 w-16 bg-brand-ai/20 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                                <Mail className="h-8 w-8 text-brand-ai" />
                            </div>
                            <h3 className="font-display font-bold text-2xl text-brand-dark mb-2">Email</h3>
                            <p className="text-xl font-bold text-brand-ai mb-4">hello@wdft.uk</p>
